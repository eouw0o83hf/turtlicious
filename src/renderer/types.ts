...
/** A line segment drawn while the pen is down. */
...
/** An arc segment drawn while the pen is down. */
...
/** A circle segment drawn while the pen is down. */
...
/** Base segment properties shared by all segment types. */
...
/** A single drawable segment (line, arc, or circle). */
export type Segment = (LineSegment | ArcSegment | CircleSegment) & SegmentBase;
